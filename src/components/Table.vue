<template>
  <div class="table">
    ...
    <!--弹出框-->
    <el-dialog :title="dialogData.title" :visible.sync="dialogData.showModel" >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogData.showModel = false">取 消</el-button>
        <el-button type="primary" @click="dialogData.func">确 定</el-button>
      </div>
    </el-dialog>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addUser(){
        this.editRow = {name:'',age:'',sex: 1,addr:'',birth:''};
        this.showAddModel()
      },
      addSubmit(){
      ...
      showAddModel(){
        ...
        this.dialogData.showModel = true;
        this.dialogData.func = this.addSubmit;
      },
      // 打开修改模态框的方法
      showEditModel(){
        this.dialogData.title = '修改信息';
        this.dialogData.showModel = true;
        this.dialogData.func = this.editSubmit;
      },
